...
#ifndef BLUERME_DEFINITIONS_H_
#define BLUERME_DEFINITIONS_H_

#define __W_BLUERME_APPLICATION_NAME__ wxString("Remere's Map Editor")

// Version info
// xxyyzzt (major, minor, subversion)
#define __BLUERME_VERSION_MAJOR__      3
#define __BLUERME_VERSION_MINOR__      8
#define __BLUERME_SUBVERSION__         0
...
#define __BLUERME_VERSION_ID__ MAKE_VERSION_ID(\
	__BLUERME_VERSION_MAJOR__, \
    __BLUERME_VERSION_MINOR__, \
    __BLUERME_SUBVERSION__)

#ifdef __EXPERIMENTAL__
#   define __BLUERME_VERSION__ std::string(i2s(__BLUERME_VERSION_MAJOR__) + "." + i2s(__BLUERME_VERSION_MINOR__) + "." + i2s(__BLUERME_SUBVERSION__) + " BETA")
#   define __W_BLUERME_VERSION__ (wxString() << __BLUERME_VERSION_MAJOR__ << "." << __BLUERME_VERSION_MINOR__ << "." << __BLUERME_SUBVERSION__ << " BETA")
#elif __SNAPSHOT__
#   define __BLUERME_VERSION__ std::string(i2s(__BLUERME_VERSION_MAJOR__) + "." + i2s(__BLUERME_VERSION_MINOR__) + "." + i2s(__BLUERME_SUBVERSION__) + " - SNAPSHOT")
#   define __W_BLUERME_VERSION__ (wxString() << __BLUERME_VERSION_MAJOR__ << "." << __BLUERME_VERSION_MINOR__ << "." << __BLUERME_SUBVERSION__ << " - SNAPSHOT")
#else
#   define __BLUERME_VERSION__ std::string(i2s(__BLUERME_VERSION_MAJOR__) + "." + i2s(__BLUERME_VERSION_MINOR__) + "." + i2s(__BLUERME_SUBVERSION__))
#   define __W_BLUERME_VERSION__ (wxString() << __BLUERME_VERSION_MAJOR__ << "." << __BLUERME_VERSION_MINOR__ << "." << __BLUERME_SUBVERSION__)
#endif
// OS
