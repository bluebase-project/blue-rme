	...
	grid_sizer->Add(newd wxStaticText(this, wxID_ANY, "Map Dimensions"));
	{
		...
		subsizer->Add(
			width_spin =
				...
				wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, bluerme::MapMinWidth, bluerme::MapMaxWidth), wxSizerFlags(1).Expand()
			);
		subsizer->Add(
			height_spin =
				newd wxSpinCtrl(this, wxID_ANY, wxstr(i2s(map.getHeight())),
				wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, bluerme::MapMinHeight, bluerme::MapMaxHeight), wxSizerFlags(1).Expand()
			);
	...
	editor(editor)
{
	...
	x_offset_ctrl = newd wxSpinCtrl(tmpsizer->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(60, 23), wxSP_ARROW_KEYS, -bluerme::MapMaxHeight, bluerme::MapMaxHeight);
	tmpsizer->Add(x_offset_ctrl, 0, wxALL, 5);
	tmpsizer->Add(newd wxStaticText(tmpsizer->GetStaticBox(), wxID_ANY, "Offset Y:"), 0, wxALL, 5);
	y_offset_ctrl = newd wxSpinCtrl(tmpsizer->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(60, 23), wxSP_ARROW_KEYS, -bluerme::MapMaxHeight, bluerme::MapMaxHeight);
	tmpsizer->Add(y_offset_ctrl, 0, wxALL, 5);
	tmpsizer->Add(newd wxStaticText(tmpsizer->GetStaticBox(), wxID_ANY, "Offset Z:"), 0, wxALL, 5);
	z_offset_ctrl = newd wxSpinCtrl(tmpsizer->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(60, 23), wxSP_ARROW_KEYS, -bluerme::MapMaxLayer, bluerme::MapMaxLayer);
	...
	editor(editor)
{
	...
	floor_number = newd wxSpinCtrl(this, wxID_ANY, i2ws(bluerme::MapGroundLayer), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, bluerme::MapMinLayer, bluerme::MapMaxLayer, bluerme::MapGroundLayer);
	...
	editor(editor)
{
	...
	posctrl = newd PositionCtrl(this, "Destination", map.getWidth() / 2, map.getHeight() / 2, bluerme::MapGroundLayer, map.getWidth(), map.getHeight());
