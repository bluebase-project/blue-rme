...
#ifndef _BLUERME_POSITION_CTRL_H_
#define _BLUERME_POSITION_CTRL_H_
...
public:
	PositionCtrl(wxWindow* parent, const wxString& label, int x, int y, int z,
		int maxx = bluerme::MapMaxWidth, int maxy = bluerme::MapMaxHeight, int maxz = bluerme::MapMaxLayer);
	~PositionCtrl();
